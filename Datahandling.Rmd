...
All2009$HEATOTH<-recode(All2009$HEATOTH,c("0"="NO","1"="YES","-2"=NA))
...
All2009$EQUIPAUX<-recode(All2009$EQUIPAUX,c("0"="NO","1"="YES","-2"=NA))
...
All2009$WARMAIR<-recode(All2009$WARMAIR,c("0"="NO","1"="YES","-2"=NA))
...
All2009$STEAMR<-recode(All2009$STEAMR,c("0"="NO","1"="YES","-2"=NA))
...
All2009$PERMELEC<-recode(All2009$PERMELEC,c("0"="NO","1"="YES","-2"=NA))
...
All2009$PIPELESS<-recode(All2009$PIPELESS,c("0"="NO","1"="YES","-2"=NA))
...
All2009$ROOMHEAT<-recode(All2009$ROOMHEAT,c("0"="NO","1"="YES","-2"=NA))
...
All2009$WOODKILN<-recode(All2009$WOODKILN,c("0"="NO","1"="YES","-2"=NA))
...
All2009$CARRYEL<-recode(All2009$CARRYEL,c("0"="NO","1"="YES","-2"=NA))
...
All2009$CARRYKER<-recode(All2009$CARRYKER,c("0"="NO","1"="YES","-2"=NA))
...
All2009$CHIMNEY<-recode(All2009$CHIMNEY,c("0"="NO","1"="YES","-2"=NA))
...
All2009$RANGE<-recode(All2009$RANGE,c("0"="NO","1"="YES","-2"=NA))
...
All2009$DIFEQUIP<-recode(All2009$DIFEQUIP,c("0"="NO","1"="YES","-2"=NA))
...
All2009$HEATROOM[All2009$HEATROOM==-2]<-NA

All2009$HEATROOM<-as.numeric(All2009$HEATROOM)

All2009$HEATROOM<-recode(All2009$HEATROOM,c("1"=NA))

summary(All2009$HEATROOM)

#THERMAIN

All2009$THERMAIN<-recode(All2009$THERMAIN,c("0"="NO","1"="YES","-2"=NA))
...
All2009$NUMTHERM[All2009$NUMTHERM==-2]<-NA

All2009$NUMTHERM<-as.numeric(All2009$NUMTHERM)

All2009$NUMTHERM<-recode(All2009$NUMTHERM,c("1"=NA))
