...
All2009$PCTYPE1<-recode(All2009$PCTYPE1,c("1"="Desktop","Laptop","-2"=NA))

summary(All2009$PCTYPE1)

#MONITOR1

All2009$MONITOR1<-recode(All2009$MONITOR1,c("1"="Standard","2"="FlatPanelLCD","-2"=NA))
...
All2009$PCONOFF1<-recode(All2009$PCONOFF1,c("0"="NO","1"="YES","-2"=NA))
