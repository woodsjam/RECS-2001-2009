...
#HEATROOM  (Possible treatment for numeric values with NA?)
...
#NUMTHERM (recodeNumeric doesn't appear to be treating NA's)
...
summary(is.na(All2009$PROTHERM))

All2009$PROTHERM<-to.TF(All2009$PROTHERM, na.choice = "KEEP")
