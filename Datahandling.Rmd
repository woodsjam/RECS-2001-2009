...
RECSSub$Income<-RECS$Income
RECSSub$Income<-as.numeric(as.character(revalue(RECS$MONEYPY,c("Less2500"=1250, "Less5K"=3750, "Less7500"=6250,"Less10K"=8750,"Less15K"=12500,"Less20K"=17500,"Less25K"=22500,"Less30K"=27500, "Less35K"=32500,"Less40K"=37500,"Less45K"=42500,"Less50K"=47500,"Less55K"=52500,"Less60"=57500,"Less65"=62500,"Less70"=67500,"Less75"=72500,"Less80"=77500, "Less85"=82500, "Less90"=87500,"Less95"=92500,"Less100K"=97500,"Less120K"=110000,"Gr120K"=IncomeTopCode))))

table(RECSSub$Year,RECSSub$Income)


```

More differences in the years

```{r}
#Setting left out to wt non-hispanic
RECSSub$Householder_Race<-relevel(RECS$Householder_Race,"Wt")
...
```
Needs to wait till the other recodes are done.
```{r}
#Combine structure and tenure

RECSSub$StrTenure<-factor(paste(as.character(RECS$KOWNRENT),as.character(RECS$TYPEHUQ),sep=""))
summary(RECSSub$StrTenure)

RECSSub$StrTenure<-relevel(RECSSub$StrTenure,"OwnSFDetached")
