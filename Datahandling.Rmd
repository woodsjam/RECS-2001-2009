...
All2009$ESFRIG2<-recode(All2009$ESFRIG2,c("0"="NO","1"="YES"))
...
All2009$NUMFREEZ<-recode(All2009$NUMFREEZ,c("1"="One","2"="Two","3"="Three"))
...
All2009$REPLCFRZ<-recode(All2009$REPLCFRZ,c("0"="NO","1"="YES"))
...
All2009$AGEFRZR2<-recode(All2009$AGEFRZR2,c("1"="<TwoYears","2"="2-4Years","3"="5-9Years","41"="10-14Years","42"="15-19Years","5"=">20Years"))
...
All2009$DWASHUSE<-recode(All2009$DWASHUSE,c("11"="<Once/Week","12"="Once/Week","13"="2-3/Week","20"="4-6/Week","30"=">=Once/Day"))
...
All2009$AGEDW<-recode(All2009$AGEDW,c("1"="<TwoYears","2"="2-4Years","3"="5-9Years","41"="10-14Years","42"="15-19Years","5"=">20Years"))
...
All2009$ESDISHW<-recode(All2009$ESDISHW,c("0"="NO","1"="YES"))
...
All2009$REPLCDW<-recode(All2009$REPLCDW,c("0"="NO","1"="YES"))
...
All2009$WASHLOAD<-recode(All2009$WASHLOAD,c("1"="<=One/Week","2"="2-4/Week","3"="5-9/Week","4"="10-14/Week","5"=">15/Week"))
...
All2009$AGECWASH<-recode(All2009$AGECWASH,c("1"="<TwoYears","2"="2-4Years","3"="5-9Years","41"="10-14Years","42"="15-19Years","5"=">20Years"))
...
All2009$ESCWASH<-recode(All2009$ESCWASH,c("0"="NO","1"="YES"))
...
All2009$DRYRFUEL<-recode(All2009$DRYRFUEL,c("1"="NaturalGas","2"="Propane/LPG","5"="Electrcity"))
...
All2009$DRYRUSE<-recode(All2009$DRYRUSE,c("1"="EveryWash","2"="Sometimes/Wash","3"="InfrequentUse"))
...
All2009$AGECDRYER<-recode(All2009$AGECDRYER,c("1"="<TwoYears","2"="2-4Years","3"="5-9Years","41"="10-14Years","42"="15-19Years","5"=">20Years"))
...
All2009$TVCOLOR<-recode(All2009$TVCOLOR,c("0"="NoTV","1"="OneTV","2"="TwoTVs","3"="ThreeTVs","4"="FourTVs","5"="FiveTVs","6"="SixTvs","7"="SevenTvs","8"="EightTvs","9"="NineTvs","10"="TenTvs","12"="TwelveTvs","14"="FourteenTvs"))
...
All2009$TVSIZE1<-recode(All2009$TVSIZE1,c("1"="<=20inch","2"="21-26inch","3"=">=37inch"))
...
All2009$PCSLEEP1<-recode(All2009$PCSLEEP1,c("0"="NO","1"="YES","-2"=NA))
...
All2009$PCTYPE2<-recode(All2009$PCTYPE2,c("1"="Desktop","2"="Laptop","-2"=NA))
...
All2009$MONITOR2<-recode(All2009$MONITOR2,c("0"="Standard","1"="FlatPanelLCD","-2"=NA))
...
All2009$TIMEON2<-recode(All2009$TIMEON2,c("1"="LT1Hour","2"="1to3Hours","3"="3to6Hours","4"="6to10Hours","5"="GT5HOUrs","-2"=NA))
...
All2009$PCONOFF2<-recode(All2009$PCONOFF2,c("0"="NO","1"="YES","-2"=NA))
...
All2009$PCSLEEP2<-recode(All2009$PCSLEEP2,c("0"="NO","1"="YES","-2"=NA))
...
All2009$INTERNET<-recode(All2009$INTERNET,c("0"="NO","1"="YES","-2"=NA))
...
All2009$INDIALUP<-recode(All2009$INDIALUP,c("0"="NO","1"="YES","-2"=NA))
...
All2009$INDSL<-recode(All2009$INDSL,c("0"="NO","1"="YES","-2"=NA))
...
All2009$INCABLE<-recode(All2009$INCABLE,c("0"="NO","1"="YES","-2"=NA))
...
All2009$INSATEL<-recode(All2009$INSATEL,c("0"="NO","1"="YES","-2"=NA))
